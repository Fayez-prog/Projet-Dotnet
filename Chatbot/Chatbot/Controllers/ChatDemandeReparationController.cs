...
namespace Chatbot.Controllers
{
    public class ChatDemandeReparationController : Controller
    {
        ...
        public async Task<string> AnalyzeIntent(string userQuestion)
        {
            ...
            - Si la question manque de précision, propose une requête qui retourne toutes les demandes.
            ...
            - Le champ ClientId est une clé étrangère qui fait référence à Id de la table clients
            - Pour afficher le nom du client, fais une jointure avec la table clients
